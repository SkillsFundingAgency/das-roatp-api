...
{
    [TestFixture]
    public class LoadAllProvidersAddressesTests
    {
        [Test]
        [MoqAutoData]
        public async Task LoadAllProvidersAddresses_OnApiFailure_ReturnsFalse(
            [Frozen] Mock<ICourseManagementOuterApiClient> apiClientMock)
        {
            ...
            var success = await sut.LoadAllProvidersAddresses();
        ...
        [Test]
        [MoqAutoData]
        public async Task LoadAllProvidersAddresses_OnNoResultFromApi_ReturnsFalse(
            [Frozen] Mock<ICourseManagementOuterApiClient> apiClientMock)
        {
            var providers = new List<Provider>();
        ...
        [Test]
        [MoqAutoData]
        public async Task LoadAllProvidersAddresses_OnAddressesReturned_ReturnsTrue(
            [Frozen] Mock<ICourseManagementOuterApiClient> apiClientMock,
        ...
        [Test]
        [MoqAutoData]
        public async Task LoadAllProvidersAddresses_OnAddressesReturnedAndNoProviderIdPresent_ReturnsTrue(
            [Frozen] Mock<ICourseManagementOuterApiClient> apiClientMock,
            [Frozen] Mock<IReloadProviderAddressesRepository> reloadProviderAddressesRepositoryMock,
            [Frozen] Mock<IImportAuditWriteRepository> importAuditWriteRepositoryMock
        )
