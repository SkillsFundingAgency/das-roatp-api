...
public class CreateProviderAllowedCourseCommandValidator : AbstractValidator<CreateProviderAllowedCourseCommand>
{
    ...
    public CreateProviderAllowedCourseCommandValidator(IStandardsReadRepository standardsReadRepository, IProviderAllowedCoursesRepository providerAllowedCoursesRepository)
    {
