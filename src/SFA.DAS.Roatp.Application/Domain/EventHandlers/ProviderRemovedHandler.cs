...
{
    public class ProviderRemovedHandler : IDomainEventHandler<ProviderAdded>
    {
        private readonly IEventPublisher _eventPublisher;

        public ProviderRemovedHandler(IEventPublisher eventPublisher)
        {
        ...
        public async Task Handle(ProviderAdded @event, CancellationToken cancellationToken = default)
        {
            ...
            await _eventPublisher.Publish(new ProviderRemovedFromRoATPEvent(@event.ProviderId));
        }
    }
}
