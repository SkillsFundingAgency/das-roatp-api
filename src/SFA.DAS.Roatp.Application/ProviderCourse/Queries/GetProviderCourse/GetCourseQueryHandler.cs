...
public class GetCourseQueryHandler : IRequestHandler<GetCourseQuery, GetCourseQueryResult>
{
    ...
    public GetCourseQueryHandler(IProviderCoursesReadRepository providerCoursesReadRepository, IStandardsReadRepository standardsReadRepository, ILogger<GetProviderCourseQueryHandler> logger)
    {
    ...
    public async Task<GetCourseQueryResult> Handle(GetCourseQuery request, CancellationToken cancellationToken)
    {
        ...
        return new GetCourseQueryResult { Course = providerCourse };
    }
}