...
{
    public class LarsCodeUkprnCheckerValidator : AbstractValidator<ILarsCodeUkprn>
    {
        ...
        public LarsCodeUkprnCheckerValidator(IProvidersReadRepository providersReadRepository, IProviderCoursesReadRepository providerCoursesReadRepository)
        {
