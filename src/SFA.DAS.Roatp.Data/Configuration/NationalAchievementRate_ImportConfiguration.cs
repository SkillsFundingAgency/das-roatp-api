...
namespace SFA.DAS.Roatp.Data.Configuration
{
    ...
    public class NationalAchievementRate_ImportConfiguration : IEntityTypeConfiguration<NationalAchievementRate_Import>
    {
        public void Configure(EntityTypeBuilder<NationalAchievementRate_Import> builder)
        {
            builder.ToTable(nameof(NationalAchievementRate_Import));
