...
[TestFixture]
public class ProviderAllCoursesExternalQueryHandlerTests
{
    ...
    public async Task Handle_ReturnsResult(
        ...
        GetAllProviderCoursesExternalQueryHandler sut,
        CancellationToken cancellationToken)
    {
        GetAllProviderCoursesExternalQuery externalQuery = new GetAllProviderCoursesExternalQuery(1, true);
        ...
        providersReadRepositoryMock.Setup(r => r.GetAllProviderCourses(externalQuery.Ukprn)).ReturnsAsync(courses);
        ...
        CancellationToken cancellationToken)
    {
        ...
        repoMock.Setup(r => r.GetAllProviderCourses(externalQuery.Ukprn)).ReturnsAsync(new List<Domain.Entities.ProviderCourse>());
        ...
        int expectedCoursesCount)
    {
        ...
        providersReadRepositoryMock
            .Setup(r => r.GetAllProviderCourses(externalQuery.Ukprn))
        ...
        var sut = fixture.Create<GetAllProviderCoursesExternalQueryHandler>();
    ...
    CancellationToken cancellationToken)
    {
        ...
        GetAllProviderCoursesExternalQuery externalQuery = new GetAllProviderCoursesExternalQuery(1, false);
