...
namespace SFA.DAS.Roatp.Api.UnitTests.Controllers
{
    ...
    public class ProviderCourseLocationsEditControllerTests
    {
        ...
        public async Task AddNationalLocationToProviderCourseLocations_CallsHandler(int ukprn, string larsCode, AddNationalLocationToProviderCourseLocationsModel model, int providerCourseLocationId)
        {
        ...
        [Test, RecursiveMoqAutoData]
        public async Task CreateProviderCourseLocation_CallsHandler(int ukprn, string larsCode, AddProviderCourseLocationModel model, int providerCourseLocationId)
        {
            var mediatorMock = new Mock<IMediator>();
