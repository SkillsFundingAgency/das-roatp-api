...
namespace SFA.DAS.Roatp.Api.Controllers
{
    ...
    public class GetProviderController : ControllerBase
    {
        ...
        private readonly IGetProviderService _providerService;

        public GetProviderController(
            ILogger<GetProviderController> logger,
            IGetProviderService providerService)
        {
            _logger = logger;
