...
namespace SFA.DAS.Roatp.Application.UnitTests.Locations.Commands.CreateLocation
{
    ...
    public class CreateProviderLocationCommandValidatorTests
    {
        ...
        public async Task Validate_LocationNameDuplicate_IsInvalid(string name, bool isValid)
        {
            ...
            var sut = new CreateProviderLocationCommandValidator(providerReadRepositoryMock.Object, providerLocationsReadRepositoryMock.Object);
        ...
        public async Task Validate_Email(string email, bool isValid)
        {
            ...
            var result = await validator.TestValidateAsync(new CreateProviderLocationCommand { Email = email });
        ...
        public async Task Validate_Website(string url, bool isValid)
        {
            ...
            var result = await validator.TestValidateAsync(new CreateProviderLocationCommand { Website = url });
        ...
        public async Task Validate_Phone(string phone, bool isValid)
        {
            ...
            var result = await validator.TestValidateAsync(new CreateProviderLocationCommand { Phone = phone });
